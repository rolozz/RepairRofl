 ...
 * <p>
 * Предоставляет REST-эндпоинт для получения случайного клиента.
 * </p>
 */
@RestController
...
public class ClientController {
     ...
     * <p>
     * Этот метод вызывает сервисный слой для получения случайного {@link Client},
     * преобразованного в {@link ClientDto}, и возвращает его в виде HTTP-ответа.
     * </p>
     *
